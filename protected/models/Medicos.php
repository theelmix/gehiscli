...
class Medicos extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'directorios' => array(self::HAS_MANY, 'Directorio', 'medico_id'),
			'citases' => array(self::HAS_MANY, 'Citas', 'medico_id'),
			'asignaciones' => array(self::HAS_MANY, 'Asignaciones', 'id_responsable'),
			'historiaClinicas' => array(self::HAS_MANY, 'HistoriaClinica', 'medico_prescripcion'),
		);
	}
